...
public class Instantion implements CommandLineRunner
{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("23/03/2018"), "Partiu Viagem", "Vou para SP, abrços!",new AuthorDTO(maria));
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia ", "Acordei feliz, hoje..",new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Boa Viagem mano!", sdf.parse("21/03/2018"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite!", sdf.parse("22/03/2018"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha um otio dia!", sdf.parse("23/03/2018"), new AuthorDTO(alex));
